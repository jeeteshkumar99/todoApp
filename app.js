...
function addTodo(){
    ...
    delBtn.setAttribute("class","btn btn-primary mx-1 my-1")
...
function editFunc(e){
    var reqPrompt = prompt("Enter updated value", e.parentNode.firstChild.textContent)
    e.parentNode.firstChild.textContent = reqPrompt
